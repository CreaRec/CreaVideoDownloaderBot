...
With OpenAI configured, downloads are saved under the configured download directory like this:

- Films: `Film/<Film Name>.<ext>`
- TV shows: `TVShow/<Show Name>/Season <n>/<episodeNumber>.<ext>`
